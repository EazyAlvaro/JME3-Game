...
public class GameClient extends SimpleApplication
    ...
    //InterpolatedHeightMap hmh = new InterpolatedHeightMap(multipl, sourceMap2); */
    //custom.setHeightMap(hmh);
    ...
    public void initGridMap() {
        ...
        this.base.setFrequency(0.25f);
        this.base.setAmplitude(0.5f);
...
//        camNode.lookAt(player.getViewDirection(), Vector3f.UNIT_Y); 
    ...
    public void onAction(String binding, boolean value, float tpf) {
       ...
       /* if (binding.equals("wireframe") && !value) {
            ...
            if (!wireframe) {
                ...
                System.out.println("SINGLE MATERIAL!");
                terrain_single.setMaterial(terrain_single_material);
            }
        }*/
    }
    ...
    public void initGridMaterials() { // dirt, grass, rock
        ...
        // These Alpha-maps should ALSO be procedural
       ...
       // this.terrain_grid_material.setTexture("slopeColorMap", grass);
       // this.terrain_grid_material.setFloat("slopeTileFactor", 32);

        //this.terrain_grid_material.setFloat("terrainSize", 513);
    ...
    public void initSimpleMapMaterials() {
        ...
        //terrain_mat.setTexture("Alpha", assetManager.loadTexture("Textures/Terrain/splat/alphamap.png"));
        // HEIGHTMAP image (for the terrain heightmap)
        //Texture heightMapImage = assetManager.loadTexture("Textures/Terrain/splat/mountains512.png");

        // GRASS texture
        Texture grass = assetManager.loadTexture("Textures/Terrain/splat/grass.jpg");//grass.jpg
        grass.setWrap(WrapMode.Repeat);
        ...
        // ROCK texture
        Texture rock = assetManager.loadTexture("Textures/Terrain/splat/road.jpg"); //road.jpg
        rock.setWrap(WrapMode.Repeat);
        terrain_single_material.setTexture("DiffuseMap_2", rock);
        terrain_single_material.setFloat("DiffuseMap_2_scale", rockScale);

        // BRICK texture
        Texture brick = assetManager.loadTexture("Textures/Terrain/BrickWall/BrickWall.jpg"); //BrickWall/BrickWall.jpg
        brick.setWrap(WrapMode.Repeat);
        terrain_single_material.setTexture("DiffuseMap_3", brick);
        terrain_single_material.setFloat("DiffuseMap_3_scale", rockScale);

        // RIVER ROCK texture
        Texture riverRock = assetManager.loadTexture("Textures/Terrain/Pond/Pond.jpg"); //Pond/Pond.jpg
